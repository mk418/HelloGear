...
local function BuildPanel()
    ...
    undressButton:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_RIGHT")
        GameTooltip:AddLine("Take everything off, into your bags", 1, 1, 1, true)
        GameTooltip:AddLine("Needs a free bag slot per item; it says so if it runs out.",
            0.7, 0.7, 0.7, true)
        GameTooltip:Show()
    end)
    undressButton:SetScript("OnLeave", GameTooltip_Hide)
